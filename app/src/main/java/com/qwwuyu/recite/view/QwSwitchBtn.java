...
public class QwSwitchBtn extends View {
    ...
    public QwSwitchBtn(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public QwSwitchBtn(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    private void init(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.QwSwitchBtn);
        style = a.getInteger(R.styleable.QwSwitchBtn_btn_style, ROUND);
        bg_open = a.getColor(R.styleable.QwSwitchBtn_bg_open, 0xff45C01A);
        bg_close = a.getColor(R.styleable.QwSwitchBtn_bg_close, 0xffAAAAAA);
        bg_line = a.getColor(R.styleable.QwSwitchBtn_bg_line, 0xffAAAAAA);
        btn_bg = a.getColor(R.styleable.QwSwitchBtn_btn_bg, 0xffffffff);
        btn_line = a.getColor(R.styleable.QwSwitchBtn_btn_line, 0xffffffff);
        mChecked = a.getBoolean(R.styleable.QwSwitchBtn_checked, false);
        sw = dip2px(context, 1);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(QwSwitchBtn switchBtn, boolean isChecked);
    }

 ...
 * @date 2015-12-21
 */
public class MTraByWordActivity extends BaseActivity {
	/** 单词 */
	...
	protected int getContentViewId() {
		return R.layout.a_mtrabyword;
	}

	@Override
	protected void findViews() {
		txt_text = (TextView) findViewById(R.id.mtrabyword_txt_text);
		txt_content = (TextView) findViewById(R.id.mtrabyword_txt_content);
		txt_sound = (TextView) findViewById(R.id.mtrabyword_txt_sound);
		txt_show = (TextView) findViewById(R.id.mtrabyword_txt_show);
		txt_progress = (TextView) findViewById(R.id.mtrabyword_txt_progress);
		txt_up = (TextView) findViewById(R.id.mtrabyword_txt_up);
		txt_down = (TextView) findViewById(R.id.mtrabyword_txt_down);
	}

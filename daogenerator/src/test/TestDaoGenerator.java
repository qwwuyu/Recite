...
//		testDaoGenerator.generate();
	...
	public void generate() throws Exception {
		...
		daoGenerator.generateAll(schema, "/greendao");
		// daoGenerator.generateAll(schema2, "/greendao1");
		// daoGenerator.generateAll(schemaUnitTest, "/greendao2");
	}
	...
	protected Entity createDate() {
		...
		dateEntity.addDateProperty("date").codeBeforeField("// Test code for\n    // field").codeBeforeGetter("// Test code for\n    // getter")
				.codeBeforeSetter("// Test code for\n    // setter");
